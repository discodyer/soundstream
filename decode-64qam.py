...
def decode_wav_to_data(input_file):
    ...
    # 定义频率到符号的映射
    freq_map = {1000 + i * 100: format(i, '06b') for i in range(64)}  # 创建64个频率
    tolerance = 50  # 频率容差
    ...
    for i in range(num_symbols):
        ...
        # 打印检测到的频率
        print(f"符号 {i} 的检测频率: {detected_freq:.2f} Hz")
        ...
        for freq, bits in freq_map.items():
            ...
            print(f"无法识别的频率: {detected_freq:.2f} Hz")
